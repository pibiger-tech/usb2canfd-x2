...
int main()
{
   ...
   /*if(!find_can(0))
   {
	...
	// system("sudo ip link set can0 type can bitrate 1000000");
        system("sudo ip link set can0 up type can bitrate 50000 dbitrate 2000000 fd on");
    //system("sudo echo 1000000 > /sys/class/net/can0/can_bittiming/bitrate");
    system("sudo ifconfig can0 up");
    printf("This is a can receive demo,can0 with BitRate 500kBit/s,Date Bit Rate 2MBit/s!\r\n");
    /*Create socket*/
